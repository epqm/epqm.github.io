...
<div class="covering" id="whatisepqm">
<span class="readmore btn btn--danger" onclick="readmore()">Show More</span>
</div>
<div class="hidden_details" id="whatisepqm__hidden" markdown=1>
...
<div class="readless btn btn--warning" id="whatisepqm__less" onclick="readless()">Show Less</div>
