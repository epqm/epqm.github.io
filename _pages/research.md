...
All of this means that approaches that rely on perturbation theory or mean-field theory often do not work in dealing with stronngly interacting quantum matter (espeically fermions and quantum spins!), and non-perturbative approaches are called for. This is where EPQM's work often lies. This involves the creation of a new language (i.e., new tools and techniques) for fermionic criticality. Also, testing how well this new language describes experimentally observed phenomena, as this holds the key to the discovery of novel quantum materials (think room temperature superconductivity!) and the development of quantum devices and technology (think quantum circuitry and quantum computers!). 
